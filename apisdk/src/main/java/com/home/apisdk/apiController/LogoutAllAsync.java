...
public class LogoutAllAsync extends AsyncTask<SimultaneousLogoutInput, Void, Void> {
    ...
    private int code;
    private LogoutAllListener listener;
    private Context context;

    /**
     * Interface used to allow the caller of a LogoutAllAsync to run some code when get
     * responses.
     */

    public interface LogoutAllListener {
        ...
        void onLogoutAllPreExecuteStarted();
        ...
        void onLogoutAllPostExecuteCompleted(int code);
    }
    ...
    public LogoutAllAsync(SimultaneousLogoutInput simultaneousLogoutInput, LogoutAllListener listener, Context context) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        listener.onLogoutAllPreExecuteStarted();
        code = 0;
        if (!PACKAGE_NAME.equals(SDKInitializer.getUser_Package_Name_At_Api(context))) {
            this.cancel(true);
            message = "Packge Name Not Matched";
            listener.onLogoutAllPostExecuteCompleted(code);
            return;
        }
