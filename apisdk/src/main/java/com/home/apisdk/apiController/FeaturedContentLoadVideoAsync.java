...
public class FeaturedContentLoadVideoAsync extends AsyncTask<LoadVideoInput, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a FeaturedContentLoadVideoAsync to run some code when get
     * responses.
     */
    ...
    public interface GetFeatureContentListener {
        ...
        void onGetFeaturedContentPreExecuteStarted();
        ...
        void onFeaturedContentPostExecuteCompleted(ArrayList<LoadVideoOutput> loadVideoOutputs, int code, String status);
    }
    ...
    public FeaturedContentLoadVideoAsync(LoadVideoInput loadVideoInput, GetFeatureContentListener listener, Context context) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        listener.onGetFeaturedContentPreExecuteStarted();
        code = 0;
        if (!PACKAGE_NAME.equals(SDKInitializer.getUser_Package_Name_At_Api(context))) {
            this.cancel(true);
            message = "Packge Name Not Matched";
            listener.onFeaturedContentPostExecuteCompleted(loadVideoOutputs, code, responseStr);
            return;
        }
