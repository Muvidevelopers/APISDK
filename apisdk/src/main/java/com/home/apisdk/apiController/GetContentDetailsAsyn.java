 ...
 * @author MUVI
 */
public class GetContentDetailsAsyn extends AsyncTask<ContentDetailsInput, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a GetContentDetailsAsyn to run some code when get
     * responses.
     */
    ...
    public GetContentDetailsAsyn(ContentDetailsInput contentDetailsInput, GetContentDetailsListener listener, Context context) {
