...
public class GetFastForwardVideoLogDetailsAsync extends AsyncTask<FFVideoLogDetailsInput, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a GetFastForwardVideoLogDetailsAsync to run some code when get
     * responses.
     */
    ...
    public interface GetVideoLogsListener {
        ...
        void onGetVideoLogsPostExecuteCompleted(int code, String status, String videoLogId);
    }
    ...
    public GetFastForwardVideoLogDetailsAsync(FFVideoLogDetailsInput ffVideoLogDetailsInput, GetVideoLogsListener listener, Context context) {
    ...
    protected void onPreExecute() {
        ...
        if (!PACKAGE_NAME.equals(SDKInitializer.getUser_Package_Name_At_Api(context))) {
            ...
            listener.onGetVideoLogsPostExecuteCompleted(code, responseStr, videoLogId);
            return;
        }
