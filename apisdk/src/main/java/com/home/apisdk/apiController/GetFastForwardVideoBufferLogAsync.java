...
public class GetFastForwardVideoBufferLogAsync extends AsyncTask<VideoBufferLogsInputModel, Void, Void> {
    ...
    private VideoBufferLogsListener listener;
    private Context context;

    /**
     * Interface used to allow the caller of a GetFastForwardVideoBufferLogAsync to run some code when get
     * responses.
     */

    public interface VideoBufferLogsListener {
        ...
        void onVideoBufferLogsPreExecuteStarted();
        ...
        void onVideoBufferLogsPostExecuteCompleted(VideoBufferLogsOutputModel videoBufferLogsOutput, int status, String message);
    }
     ...
     * @param listener             VideoBufferLogsListener
     * @param context              android.content.Context
     */

    public GetFastForwardVideoBufferLogAsync(VideoBufferLogsInputModel videoBufferLogsInput, VideoBufferLogsListener listener, Context context) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        listener.onVideoBufferLogsPreExecuteStarted();
        status = 0;
        if (!PACKAGE_NAME.equals(SDKInitializer.getUser_Package_Name_At_Api(context))) {
            this.cancel(true);
            message = "Packge Name Not Matched";
            listener.onVideoBufferLogsPostExecuteCompleted(videoBufferLogsOutput, status, message);
            return;
        }
