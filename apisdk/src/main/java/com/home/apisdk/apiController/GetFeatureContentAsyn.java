 ...
 */
public class GetFeatureContentAsyn extends AsyncTask<FeatureContentInputModel, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a GetFeatureContentAsyn to run some code when get
     * responses.
     */
    ...
    public GetFeatureContentAsyn(FeatureContentInputModel featureContentInput, GetFeatureContentListener listener, Context context) {
