 ...
 * @author MUVI
 */
public class CheckGeoBlockCountryAsyn extends AsyncTask<CheckGeoBlockInputModel, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a CheckGeoBlockCountryAsyn to run some code when get
     * responses.
     */
    ...
    public CheckGeoBlockCountryAsyn(CheckGeoBlockInputModel checkGeoBlockInput, CheckGeoBlockForCountryListener listener, Context context) {
