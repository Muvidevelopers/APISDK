 ...
 * @author MUVI
 */
public class GetContentListAsyn extends AsyncTask<ContentListInput, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a GetContentListAsyn to run some code when get
     * responses.
     */
    ...
    public GetContentListAsyn(ContentListInput contentListInput, GetContentListListener listener, Context context) {
