...
public class ContactUsAsyn extends AsyncTask<ContactUsInputModel, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a ContactUsAsyn to run some code when get
     * responses.
     */
    ...
    public ContactUsAsyn(ContactUsInputModel contactUsInput, ContactUsListener listener, Context context) {
