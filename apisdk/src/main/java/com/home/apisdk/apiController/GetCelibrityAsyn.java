...
public class GetCelibrityAsyn extends AsyncTask<CelibrityInputModel, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a GetCelibrityAsyn to run some code when get
     * responses.
     */
    ...
    public GetCelibrityAsyn(CelibrityInputModel celibrityInput, GetCelibrityListener listener, Context context) {
