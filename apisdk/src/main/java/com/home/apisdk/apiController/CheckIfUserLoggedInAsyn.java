 ...
 * @author MUVI
 */
public class CheckIfUserLoggedInAsyn extends AsyncTask<CheckIfUserLoggedInInputModel, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a CheckIfUserLoggedInAsyn to run some code when get
     * responses.
     */
    ...
    public CheckIfUserLoggedInAsyn(CheckIfUserLoggedInInputModel checkIfUserLoggedInInput, CheckIfUserLogggedInListener listener, Context context) {
