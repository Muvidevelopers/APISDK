...
public class ManageDevicesAsync extends AsyncTask<LoadRegisteredDevicesInput, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a ManageDevicesAsync to run some code when get
     * responses.
     */
    ...
    public interface ManageDevicesListener {
        ...
        void onManageDevicesPreExecuteStarted();
        ...
        void onManageDevicesPostExecuteCompleted(ArrayList<LoadRegisteredDevicesOutput> loadRegisteredDevicesOutputs, int status, String message);
    }
    ...
    public ManageDevicesAsync(LoadRegisteredDevicesInput loadRegisteredDevicesInput, ManageDevicesListener listener, Context context) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        listener.onManageDevicesPreExecuteStarted();
        status = 0;
        if (!PACKAGE_NAME.equals(SDKInitializer.getUser_Package_Name_At_Api(context))) {
            this.cancel(true);
            message = "Packge Name Not Matched";
            listener.onManageDevicesPostExecuteCompleted(loadRegisteredDevicesOutputArrayList, status, responseStr);
            return;
        }
