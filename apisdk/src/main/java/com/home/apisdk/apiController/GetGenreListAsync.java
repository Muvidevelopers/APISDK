...
public class GetGenreListAsync extends AsyncTask<GenreListInput, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a GetGenreListAsync to run some code when get
     * responses.
     */
    ...
    public GetGenreListAsync(GenreListInput genreListInput, GenreListListener listener, Context context) {
        ...
        Log.v("MUVISDK", "GetGenreListAsync");
