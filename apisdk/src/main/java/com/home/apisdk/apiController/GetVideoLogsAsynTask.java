...
public class GetVideoLogsAsynTask extends AsyncTask<VideoLogsInputModel, Void, Void> {
    ...
    public interface GetVideoLogsListener {
        ...
        void onGetVideoLogsPostExecuteCompleted(Video_Log_Output_Model video_log_output_model, int status, String message,String response);
    }
    ...
    protected void onPreExecute() {
        ...
        if (!PACKAGE_NAME.equals(SDKInitializer.getUser_Package_Name_At_Api(context))) {
            ...
            listener.onGetVideoLogsPostExecuteCompleted(video_log_output_model, status, message,responseStr);
            return;
        }
