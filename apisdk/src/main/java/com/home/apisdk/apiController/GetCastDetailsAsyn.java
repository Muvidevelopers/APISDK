 ...
 * @author MUVI
 */
public class GetCastDetailsAsyn extends AsyncTask<GetCastDetailsInput, Void, Void> {
    ...
    /**
     * Interface used to allow the caller of a GetCastDetailsAsyn to run some code when get
     * responses.
     */
    ...
    public GetCastDetailsAsyn(GetCastDetailsInput getCastDetailsInput, GetCastDetailsListener listener, Context context) {
